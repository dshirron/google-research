...
# from tensorflow.python.ops import add_arg_scope # dans tf2 compat
from tensorflow.python.ops import variables # dans tf2 compat
# from tensorflow.python.layers import initializers
import tensorflow.compat.v1.keras.initializers as initializers #dans tf2 compat
from tensorflow.python.layers import utils # dans tf2 compat
from state_of_sparsity.layers.contrib.layers import core_layers as core # dans tf2 compat
...
def masked_convolution(inputs,
                       ...
                       weights_initializer=initializers.glorot_normal(), # dans tf2 compat
