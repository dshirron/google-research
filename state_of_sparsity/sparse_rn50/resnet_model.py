...
#from tensorflow.contrib import layers as contrib_layers # Dans for tf2 replaced with keras l2 regulazer
...
def conv2d_fixed_padding(inputs,
  ...
  kernel_regularizer = regularizers.l2(weight_decay) # dans tf2 compat
